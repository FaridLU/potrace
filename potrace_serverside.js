...
function Potrace() {
		...
		function loadCanvas() {
			...
			imgCanvas = createCanvas(imgElement.width, imgElement.height)
		...
		function processPath() {
			...
			function bezier(t, p0, p1, p2, p3) { // Casteljau's Algorithm { https://www.youtube.com/watch?v=YATikPP2q70
